package com.fantasy.maker.template;
...
import com.fantasy.maker.meta.enums.FileGenerateTypeEnum;
import com.fantasy.maker.meta.enums.FileTypeEnum;
import com.fantasy.maker.template.enums.FileFilterRangeEnum;
import com.fantasy.maker.template.enums.FileFilterRuleEnum;
import com.fantasy.maker.template.model.FileFilterConfig;
import com.fantasy.maker.template.model.TemplateMakerFileConfig;
import com.fantasy.maker.template.model.TemplateMakerModelConfig;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        // 指定原始项目路径
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = FileUtil.getAbsolutePath(new File(projectPath).getParent() + File.separator + "code-generator-demo-projects/springboot-init");
        String fileInputPath1 = "src/main/java/com/fantasy/springbootinit/common";
...
//        String searchStr = "结果: ";
        ...
        long id = TemplateMaker.makeTemplate(meta, originProjectPath, templateMakerFileConfig, templateMakerModelConfig, 2007383158827892736L);
    ...
    private static List<Meta.FileConfig.FileInfo> distinctFiles(List<Meta.FileConfig.FileInfo> fileInfoList) {
        ...
        // 3. 创建新的文件配置列表（结果列表），先将合并后的分钟添加到结果列表
