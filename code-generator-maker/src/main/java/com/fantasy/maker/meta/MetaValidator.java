...
import com.fantasy.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "fantasy");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.fantasy");
