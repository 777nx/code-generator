...
VALUES (1, 'ACM 模板项目', 'ACM 模板项目生成器', 'com.fantasy', '1.0', '程序员阿符', '["Java"]',
        'https://lsky.777nx.cn/i/2026/01/05/_r0_c1851-bf115939332e.jpg', '{}', '{}', null, 0, 1);
INSERT INTO my_db.generator (id, name, description, basePackage, version, author, tags, picture, fileConfig,
                             modelConfig, distPath, status, userId)
VALUES (2, 'Spring Boot 初始化模板', 'Spring Boot 初始化模板项目生成器', 'com.fantasy', '1.0', '程序员阿符', '["Java"]',
        'https://lsky.777nx.cn/i/2026/01/05/_r0_c0726-7e30f8db802a.jpg', '{}', '{}', null, 0, 1);
INSERT INTO my_db.generator (id, name, description, basePackage, version, author, tags, picture, fileConfig,
                             modelConfig, distPath, status, userId)
VALUES (3, '阿符外卖', '阿符外卖项目生成器', 'com.fantasy', '1.0', '程序员阿符', '["Java", "前端"]',
        'https://lsky.777nx.cn/i/2026/01/05/_r1_c0cf7-f8e4bd865b4b.jpg', '{}', '{}', null, 0, 1);
INSERT INTO my_db.generator (id, name, description, basePackage, version, author, tags, picture, fileConfig,
                             modelConfig, distPath, status, userId)
VALUES (4, '阿符用户中心', '阿符用户中心项目生成器', 'com.fantasy', '1.0', '程序员阿符', '["Java", "前端"]',
        'https://lsky.777nx.cn/i/2026/01/05/_r1_c1c15-79cdecf24aed.jpg', '{}', '{}', null, 0, 1);
INSERT INTO my_db.generator (id, name, description, basePackage, version, author, tags, picture, fileConfig,
                             modelConfig, distPath, status, userId)
VALUES (5, '阿符商城', '阿符商城项目生成器', 'com.fantasy', '1.0', '程序员阿符', '["Java", "前端"]',
        'https://lsky.777nx.cn/i/2026/01/05/_r1_c0709-8e80689ac1da.jpg', '{}', '{}', null, 0, 1);
